...
function ModalPopup({ FormComponent = FormLogin, formType = 'login' }) {
    ...
    return (
        //  Modal layout
        <>
            <input type="checkbox" className={cx(classNameCheckBox)} id={idCheckBox} hidden />
                    ...
                    <div className={cx('auth-form')}>
                        ...
                        <div className={cx('auth-form__socials')}>
                            ...
                            <Button
                                ...
                                leftIcon={<FontAwesomeIcon icon={faGoogle} className={cx('auth-form__socials-icon')} />}
                            >
